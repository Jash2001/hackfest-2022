...
function ProblemsTitle() {
	const ps = [
		...
		{
			psname: ' Automated Driving with traffic lights',
			ps: 3,
			img_url: ps3,
		},
		{
			psname: 'Face detection to identify temperature',
			ps: 4,
			img_url: ps4,
		},
		{
		...
		{
			psname: 'Digital app for Collaborative Innovation Center',
			ps: 14,
			img_url: ps14,
		},
